...
(function (a, b) {
  ...
  function b_(a, b, c, d) {
    if (f.isArray(b)) f.each(b, function (b, e) {
      c || bF.test(a) ? d(a, e) : b_(a + "[" + (_typeof(e) == "object" || f.isArray(e) ? b : "") + "]", e, c, d);
  ...
  var c = a.document,
    ...
    e.fn = e.prototype = {
      ...
      bindReady: function bindReady() {
        if (!y) {
          ...
          if (c.addEventListener) c.addEventListener("DOMContentLoaded", _z2, !1), a.addEventListener("load", e.ready, !1);else if (c.attachEvent) {
            c.attachEvent("onreadystatechange", _z2), a.attachEvent("onload", e.ready);
            var b = !1;
    ...
    }), x = e.uaMatch(w), x.browser && (e.browser[x.browser] = !0, e.browser.version = x.version), e.browser.webkit && (e.browser.safari = !0), j.test(" ") && (k = /^[\s\xA0]+/, l = /[\s\xA0]+$/), h = e(c), c.addEventListener ? _z2 = function z() {
      c.removeEventListener("DOMContentLoaded", _z2, !1), e.ready();
    } : c.attachEvent && (_z2 = function _z() {
      c.readyState === "complete" && (c.detachEvent("onreadystatechange", _z2), e.ready());
    });
    return e;
  }(),
  ...
  f.extend({
    ...
    data: function data(a, c, d, e) {
      if (!!f.acceptData(a)) {
        ...
        if (_typeof(c) == "object" || typeof c == "function") e ? k[l][g] = f.extend(k[l][g], c) : k[l] = f.extend(k[l], c);
  ...
  }), c.defaultView && c.defaultView.getComputedStyle && (bA = function bA(a, c) {
    var d, e, g;
  ...
  f.fn.extend({
    ...
    custom: function custom(a, b, c) {
      ...
      this.startTime = cq || cs(), this.start = a, this.end = b, this.unit = c || this.unit || (f.cssNumber[this.prop] ? "" : "px"), this.now = this.start, this.pos = this.state = 0, h.elem = this.elem, h() && f.timers.push(h) && !co && (cr ? (co = 1, _g2 = function g() {
        co && (cr(_g2), e.tick());
      }, cr(_g2)) : co = setInterval(e.tick, e.interval));
    },
    show: function show() {
